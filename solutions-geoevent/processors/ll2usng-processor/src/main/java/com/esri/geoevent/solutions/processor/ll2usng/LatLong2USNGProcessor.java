...
public class LatLong2USNGProcessor extends GeoEventProcessorBase{
	...
	public LatLong2USNGProcessor(GeoEventProcessorDefinition definition)
	...
	public GeoEvent process(GeoEvent evt) throws Exception {
		...
		String[] usngvals = new String[1];
		PeNotationUsng.geog_to_usng(pegeocs, 1, coords, accuracy, false, true, usngvals);
		String usng = usngvals[0];
