...
public class EventJsonOutboundAdapterService extends AdapterServiceBase
{
	public EventJsonOutboundAdapterService()
	{
	...
	{
		return new EventJsonOutboundAdapter(definition);
	}
}